...
class ReaderPreferences(
    ...
    // TachiyomiAT
    val showTranslations: Preference<Boolean> = preferenceStore.getBoolean("show_translations", true)
    ...
    companion object {
        const val AUTO_SCROLL_SPEED_MIN = 20
        const val AUTO_SCROLL_SPEED_MAX = 180
        const val AUTO_SCROLL_SPEED_STEP = 10
        const val AUTO_SCROLL_SPEED_DEFAULT = 60
