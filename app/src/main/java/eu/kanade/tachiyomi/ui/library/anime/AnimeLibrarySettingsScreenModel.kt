...
class AnimeLibrarySettingsScreenModel(
    ...
    fun getSortFor(category: Category?): AnimeLibrarySort {
        val flags = category?.flags ?: return libraryPreferences.animeSortingMode.get()
        return AnimeLibrarySort(
            type = AnimeLibrarySort.Type.valueOf(flags),
            direction = AnimeLibrarySort.Direction.valueOf(flags),
        )
    }
