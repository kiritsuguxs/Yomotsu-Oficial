...
object TranslationBlockGrouper {
    ...
    private const val MAX_ANGLE_DIFFERENCE = 12f; private const val MIN_SHARED_BALLOON_RATIO = 0.20f; private const val MAX_CENTER_OFFSET_RATIO = 0.35f; private const val MAX_GLYPH_GAP = 1.45f; private const val MAX_COMIC_PARAGRAPH_GLYPH_GAP = 1.49f; private const val MAX_PADDLE_PARAGRAPH_GLYPH_GAP = 0.85f; private const val MAX_CONNECTOR_GLYPH_GAP = 3.5f; private const val MAX_DETECTED_LAYOUT_GLYPH_GAP = 0.75f; private const val MIN_HORIZONTAL_OVERLAP = 0.48f; private const val MAX_COLOR_DISTANCE_SQUARED = 3_600; private const val MAX_VISUAL_SIZE_RATIO = 1.65f
