...
class SourcePreferences(
    ...
    val animeEnabledLanguages: Preference<Set<String>> = preferenceStore.getStringSet(
    ...
    val animeExtensionUpdatesCount: Preference<Int> = preferenceStore.getInt("anime_ext_updates_count", 0)
