...
class UpdateAnimeFromRemote(
    ...
    suspend fun awaitEpisodesUpdate(
        ...
        val src = source ?: sourceManager.getOrStub(anime.source)
    ...
    suspend fun awaitEpisodesUpdate(
        ...
        return try {
            ...
            Result.success(RemoteEpisodesUpdate(anime = updatedAnime, newEpisodes = newEpisodes))
        } catch (e: Exception) {
    ...
    suspend fun awaitSeasonsUpdate(
        ...
        return try {
            ...
            val updatedAnime = animeRepository.getAnimeById(anime.id)
            Result.success(RemoteSeasonsUpdate(anime = updatedAnime, newSeasons = newSeasons))
        } catch (e: Exception) {
            logcat(LogPriority.ERROR, e)
            Result.failure(e)
        }
